...
class EnvioDocumentoEstrangeiro extends Component {
    constructor(props) {
      super(props);
...
getProcessoUnico = async (id_unico, access_token) => {
  this.setState({ loadSpinner : true, mensagem : 'Aguarde ainda estamos processando...' });
  ...
  if (this.state.errorProcessoUnico === false) {
      let retScore = await this.buscaScoreUnico(this.props.codigoAF, this.props.id_unico);
      this.state.retProcesso = retScore;
  }

  return this.state.retProcesso;
}
                        ...
                        <Row>
                              {(this.props.etapaFinalizar === false  && this.props.isAnalfabetoEnvDoc === false) &&
                                <Col className="text-center" md="12" lg="12" xl="12" xs="12" sm="12">
                                    ...
                                    <Link className="btn btn-outline-primary btn-block btn-lg font-weight-bold mt-2"
                                      onClick={() => this.props.getStatusDocumento(this.props.tipoDocumento, this.state.imagem)}
                                      to="#">
                              ...
                              {(this.props.etapaFinalizar === true && this.props.isFgtsAux === true && this.props.analfabeto != 'S') &&
                                  <Col className="text-center" md="12" lg="12" xl="12" xs="12" sm="12">
                                    ...
                                    <Link className="btn btn-outline-primary btn-block btn-lg font-weight-bold mt-2"
                                      onClick={() => this.props.getStatusDocumento(this.props.tipoDocumento, this.state.imagem, this.state.isOcr, this.state.isOiti, this.state.isEncerrar)}
                                      to="#">
                              ...
                              {(this.props.isFgtsAux === false || this.props.analfabeto === 'S') && // colocar a condicao para o OITI
                                  <Col className="text-center" md="12" lg="12" xl="12" xs="12" sm="12">
                                      ...
                                      <Link className="btn btn-outline-primary btn-block btn-lg font-weight-bold mt-2"
                                        onClick={() => this.props.setEtapaAudioVideo(this.props.tipoDocumento, this.state.imagem, this.props.codigotabela, this.state.isOcr, this.state.isOiti, this.state.isEncerrar, this.state.isScoreExcep)}
                                        to="#">
                                          {this.state.labelBtn}
                                      </Link>
                                  </Col>
...
export default EnvioDocumentoEstrangeiro;