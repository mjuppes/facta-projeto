...
class FactaFgtsCcb extends Component {
                ...
                <Row className="mt-6">
                  ...
                  <Col md={{size: isMobile ? 10 : 6, offset: isMobile ? 1 : 0}} style={{ 'height' : (window.screen.height * 0.85), 'overflow' : isMobile ? "unset" : "auto" }}>
                  {
                    ...
                    <CardBody className="text-left">
                        ...
                        <h5 className="text-center border-bottom border-light pb-3 font-weight-bold">Seguro FGTS</h5>
                        <Row>
                        <Col xs="12" sm="12" xm="12">
                            <label>Benefícios:</label>
                            <p className="font-weight-bold"> - Sorteios mensais de R$ 10.000,00. </p>
                            <p className="font-weight-bold"> - Morte acidental: cobertura de R$ 10.000,00. </p>
                            <p className="font-weight-bold"> - Invalidez: Cobertura indenizatória de R$ 2.000,00. </p>
                        </Col>
                        </Row>
