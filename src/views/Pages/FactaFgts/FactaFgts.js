...
import DadosDaPropostaFgtsTemplate from '../../../DadosDaPropostaFgtsTemplate';
import DadosDaPropostaBlocoTemplate from '../../../DadosDaPropostaBlocoTemplate';
import DadosDaPropostaFgtsBlocoTemplate from '../../../DadosDaPropostaFgtsBlocoTemplate';
...
import FactaAuxBrasilQuestionario from './FactaAuxBrasilQuestionario';



class FactaFgts extends Component {
    ...
    if (this.state.aceitouSeguro === false && (this.state.vlrSeguro > 0)) {
      ...
      .catch(function (error) {
        ...
        if (this.state.etapaFinal === true) {
          ...
          if(this.state.tipoAverbador === 'auxbrasil'){
              this.state.proximoLink = '/declaracao-de-residencia/'+this.props.match.params.propostaId;
          }
          else if(this.state.vlrSeguro > 0) {
            this.state.proximoLink = '/facta-fgts-ccb/'+this.props.match.params.propostaId;
          }
            ...
            <Col className="w-100 p-3 min-vh-100 text-center" style={containerPaddingTop} id="ccbCliente">
                ...
                {this.state.isQuestionario === false &&
                  <Col md={{size: isMobile ? 10 : 6, offset: isMobile ? 1 : 0}} style={{ 'height' : (window.screen.height * 0.85), 'overflow' : isMobile ? "unset" : "auto" }}>
                    ...
                    {this.state.tipoAverbador !== "auxbrasil" &&
                     <DadosDaPropostaFgtsBlocoTemplate proposta={AF} tipo_operacao={TIPO_OPERACAO} cod_tipo_operacao={COD_TP_OPERACAO}/>
                    }
                        ...
                        <>
                           { this.state.tipoAverbador !== "auxbrasil"
                            ? (
                              ...
                              <Card className="border-white shadow" style={{borderRadius: '8px'}}>
                                <CardBody className="text-left">
                                  <h5 className="text-center border-bottom border-light pb-3 font-weight-bold"><i className="fa fa-warning" style={iconWarning}></i>  INFORMAÇÃO IMPORTANTE  <i className="fa fa-warning red-color" style={iconWarning}></i></h5>
                                  <Col xs="12" sm="12" xm="12">
                                        <Label check className="form-check-label text-justify">
                                        Ao escolher migrar para o saque aniversário e decidir voltar à sistemática do saque-rescisão, poderá solicitar a reversão a qualquer momento no APP da Caixa Econômica Federal ou dirigindo-se a uma agência.
      Vale ressaltar que, a alteração somente surtirá efeito no 1º dia do 25º mês da solicitação e desde que o Empréstimo com Garantia de Saque Aniversário FGTS esteja quitado.
                                        </Label>
                                  </Col>
                                </CardBody>
                              </Card>
                      ...
                      <CardBody className="text-left">
                        ...
                        <Row className="text-justify">
                          <Col xs="12" sm="12" xm="12">
                            ...
                            <p>
                            	1. Desta forma, o cliente promete pagar para Financeira ou qualquer instituição financeira adquirente desta operação, ou à sua ordem, o valor devido em decorrência desta cédula na forma e prazo aqui descritos e autoriza, de forma irrevogável e irretratável, pagamento através de desconto no Saldo de Conta Vinculada do FGTS de minha titularidade, oriundo do direito ao Saque-aniversário FGTS, nos termos da Resolução do Conselho Curador do FGTS Nº 958, 24/04/2020. 
                            </p>
                            <p>
                            ...
                            <p>
                            	3. Em caso de alteração pelo Poder Executivo Federal, referentes aos valores das faixas, das alíquotas, e das parcelas adicionais, a Financeira está autorizada a realizar os procedimentos descritos nos incisos a seguir, nos termos do Art. 6º, I, II da Resolução Nº 958, 24/04/2020, de modo a manter inalterado o valor total dos saques-aniversário alienados ou cedidos e satisfazer o pagamento da obrigação contraída pelo trabalhador junto a Financeira:
                            </p>
                            <p>
                              <span className="font-weight-bold">(i)</span> Elevação do valor bloqueado na forma do art. 2º, se existir saldo suficiente nas contas vinculadas do titular.
                            </p>
                            <p>
                              <span className="font-weight-bold">(ii)</span> Supletivamente, em caso de insuficiência de saldo, a ampliação dos prazos de vencimento dos contratos de que trata este artigo e, consequentemente, da quantidade de saques-aniversário cujos direitos foram alienados ou cedidos, mantidas as taxas de juros pactuadas.
                            </p>
                            <p>
                        ...
                        <Row className="text-justify">
                          <Col xs="12" sm="12" xm="12">
                            <p>
                            	Estas são as condições gerais do seu limite de crédito para empréstimo com desconto em Saldo de Conta Vinculada de FGTS de sua titularidade, oriundo
                            do direito ao Saque-aniversário FGTS, nos termos da Resolução do Conselho Curador do FGTS Nº 958, 24/04/2020. Leia atentamente e, em caso de dúvidas, consulte os canais de atendimento: Uso consciente do crédito: Evite endividar-se. Realize a contratação de empréstimos sempre de acordo com suas condições financeiras, sem comprometer o seu orçamento ou de sua família. 
                            </p>
                            <p>
                              <span className="font-weight-bold">Débito em Conta Vinculada:</span> O débito em conta vinculada é um empréstimo com parcelas descontadas diretamente do Saldo de Conta Vinculada de FGTS de sua titularidade. É condição imprescindível para a efetivação da contratação a a anuência do Agente Operador do FGTS.
                            </p>
                            <p>
                            ...
                            <p>
                              <span className="font-weight-bold">Título Executivo:</span> O presente instrumento constitui título executivo extrajudicial, nos termos do artigo 28 da Lei nº 10.931, de 02/08/2004.
                            </p>
                            <p>
                              <span className="font-weight-bold">Garantia:</span> Para garantia do bom, fiel e cabal cumprimento de todas as obrigações, principal e acessórias, decorrentes desta Cédula, o Emitente, em caráter irrevogável e irretratável, dá ao Credor, em propriedade fiduciária, com observância do disposto no artigo 66-B da Lei n.º 4.728, de 14.07.1965, introduzido pela Lei n.º 10.931, de 02.08.2004, nos artigos 1.361 a 1.368 do Código Civil, e no Decreto-Lei n.º 911, de 01.10.1969, bem como alterações posteriores, os recursos da(s) conta(s) vinculada(s) do Fundo de Garantia por Tempo de Serviço (FGTS), identificada(s) no Preâmbulo, de titularidade do Emitente, disponíveis e bloqueadas por meio da sistemática de saque-aniversário, nos termos do § 3º do artigo 20-D da Lei 8.036, de 11 de maio de 1990 e da Resolução CCFGTS n.º 958, de 24 de abril de 1990, mantendo-se referida garantia vigente e íntegra, desde a presente data, até a final liquidação do saldo devedor desta Cédula, compreendendo principal e acessórios. 
                            </p>
                            <p>
                              <span className="font-weight-bold">Cessão:</span>  O Credor poderá ceder, no todo ou em parte, os direitos, obrigações e garantias da presente Cédula, inclusive mediante a emissão de Certificado de Cédula de Crédito Bancário com lastro no presente título, podendo negociá-lo livremente no mercado.
                            </p>
                          </Col>
                        </Row>
                        ...
                        <Row className="text-justify">
                          <Col xs="12" sm="12" xm="12">
                            <p>
                              <span className="font-weight-bold">
                              1. O cliente autoriza o banco a efetivar a contratação de um empréstimo</span> liberando ao cliente maior valor possível, até o valor do limite de crédito, considerando a existência e o valor de saldo da conta vinculada, oriundo do direito ao saque-aniversário.
                            </p>
                            <p>
                              <span className="font-weight-bold">2. Valor disponível:</span> Em caso de ausência ou insuficiência de valor disponível, esta contratação poderá ser cancelada ou o valor do empréstimo poderá ser inferior ao valor do limite de crédito, de forma que o valor das parcelas se adéqüe ao valor disponível no Saldo de Conta de FGTS de sua titularidade, oriundo do direito ao saque-aniversário o que gerará um valor emprestado menor e, por conseqüência, um valor liberado ao c l i ent e inferior ao valor liberado máximo. Neste caso, a F inanceira ou qualquer instituição financeira adquirente desta operação averbará a parcela conforme a disponibilidade verificada e informará os dados financeiros finais do empréstimo. Em caso de dúvida ou para consultar as informações atualizadas do empréstimo você poderá utilizar os canais de atendimento informados.
                            </p>
                            <p>
                            ...
                            <p>
                              <span className="font-weight-bold">7. Forma de pagamento:</span> O pagamento do valor do empréstimo será realizado por meio de descontos no Saldo de Conta FGTS, oriundo do saque-aniversário , no valor necessário à quitação de cada parcela, até a quitação total. 
                            </p>

                            <p>
                              <span className="font-weight-bold">CONSIDERANDO QUE:</span>
                            </p>

                            <p>
                               Caso não seja possível o desconto no mês de aniversário no Saldo da Conta FGTS, nos casos de falta ou insuficiência de valores, o cliente deverá:
                            </p>
                            <p>
                              <span className="font-weight-bold">(i)</span> Pagar as parcelas devidas diretamente a Financeira ou qualquer instituição financeira adquirente desta operação por meio de boleto bancário;
                            </p>
                            <p>
                              <span className="font-weight-bold">(ii)</span> Verificar com a Financeira ou qualquer instituição financeira adquirente desta operação a possibilidade de reprogramar o pagamento; ou
                            </p>
                            <p>
                              <span className="font-weight-bold">(iii)</span> Pagar as parcelas mediante débito realizado em qualquer conta de sua titularidade, preferencialmente naquela indicada para crédito do valor contratado. Para tanto, resta autorizado a Financeira, ou qualquer instituição financeira adquirente desta operação a terem acesso às suas informações bancárias, nos termos do Artigo 1º, §3º da Lei Complementar 105/01, de forma a não configurar quebra de sigilo bancário.
                            </p>
                            <p>
                              <span className="font-weight-bold">8.	Atraso no pagamento:</span> Em caso de atraso no pagamento de quaisquer das parcelas ou ocorrer o vencimento antecipado do empréstimo, serão devidos sobre os valores em atraso: juros remuneratórios do período, acrescidos de juros moratórios de 1% aomês, desde o atraso até a data do efetivo pagamento, e multa de 2% sobre o valor devido.
                            </p>
                            <p>
                              Se não for possível o desconto da parcela diretamente do Saldo da Conta Vinculada do FGTS, oriundo do saque-aniversário, a Financeira ou qualquer instituição financeira adquirente desta operação, poderá em determinadas situações e de forma a não gerar prejuízo, prorrogar o vencimento das parcelas seguintes proporcionalmente ao período de atraso a fim de viabilizar o pagamento do empréstimo nas mesmas condições originalmente pactuadas. Em caso de atraso, o cliente está ciente de que terá seu nome inscrito no SPC, SERASA ou em outro órgão encarregado de cadastrar atraso no pagamento. 
                            </p>
                            <p>
                            ...
                            <p>
                              <span className="font-weight-bold">(i)</span> Se o cliente fizer algum pagamento diretamente a Financeira ou qualquer instituição financeira adquirente desta operação, mas tenha ocorrido desconto em seu saldo de conta vinculada do FGTS, oriundo do direito ao saque-aniversário, gerando pagamento em duplicidade, a Financeira ou qualquer instituição financeira adquirente desta operação poderá restituir o valor mediante crédito em conta-corrente, conta-poupança ou quaisquer outros produtos de sua titularidade mantidos na nestas instituições. 
                            </p>
                            <p>
                              <span className="font-weight-bold">(ii)</span> Caso o cliente possua parcelas vencidas e não pagas, para evitar a incidência de juros, a Financeira ou qualquer instituição financeira adquirente desta operação utilizará esse valor para amortizar qualquer saldo em atraso, deste ou de qualquer outro empréstimo que tenha com a Financeira ou qualquer instituição financeira adquirente desta operação.
                            </p>
                            <p>
                              <span className="font-weight-bold">(iii)</span> Se o valor em atraso for inferior ao pago em duplicidade, a Financeira ou qualquer instituição financeira adquirente desta operação, restituirá ao cliente a diferença conforme descrito acima. 
                            </p>
                            <p>
                              <span className="font-weight-bold">11.	Seus principais direitos:</span>
                            </p>
                            <p>
                              <span className="font-weight-bold">(i)</span> Quitar antecipadamente a dívida, com redução proporcional de juros;
                            </p>
                            <p>
                              <span className="font-weight-bold">(ii)</span> Obter informações de seu empréstimo, inclusive de eventual cessão ou endosso a terceiro;
                            </p>
                            <p>
                              <span className="font-weight-bold">(iii)</span> Solicitar a qualquer momento, uma segunda via deste documento;
                            </p>
                            <p>
                              <span className="font-weight-bold">(iv)</span> Solicitar transferência de sua divida (portabilidade) para outra instituição de sua preferência;
                            </p>
                            <p>
                              <span className="font-weight-bold">(v)</span> Ressarcimento de parcelas pagas em duplicidade.
                            </p>
                          </Col>
                        </Row>
                        ...
                        <Row className="text-justify">
                          <Col xs="12" sm="12" xm="12">
                            ...
                            <p><span className="font-weight-bold">(i)</span> Em caso de liquidação espontânea, sem ter havido qualquer ato de cobrança, não será devolvido nenhum tipo de ressarcimento de custo;</p>
                            <p><span className="font-weight-bold">(ii)</span> Endossar ou ceder esta cédula, total ou parcialmente;</p>
                            <p><span className="font-weight-bold">(iii)</span> Exigir pagamento imediato em caso de não cumprimento do cliente com suas obrigações, com a suspensão da consignação das parcelas ou demais penalidades conforme previstas em lei;</p>
                            <p><span className="font-weight-bold">(iv)</span> Utilizar, em caso de desoneração ou rescisão do seu contrato de trabalho, as suas verbas rescisórias para liquidação total ou parcial da dívida, observando limites legais;</p>
                            <p><span className="font-weight-bold">(v)</span> Realizar a compensação de saldo devedor do empréstimo com eventuais créditos que o cliente tenha na Financeira ou qualquer instituição financeira adquirente desta operação, decorrentes de depósitos à vista ou a prazo, ou aplicação financeira em valor suficiente para a liquidação do saldo devedor.</p>
                            ...
                            <p><span className="font-weight-bold">DEMAIS DECLARAÇÕES:</span>  Responsabilizo-me pela exatidão e veracidade das informações e documentos apresentados, bem como declaro:</p>

                            <p><span className="font-weight-bold">(i)</span> Conhecer e respeitar as disposições da Lei 9.613/98, e suas alterações, do Código Penal que versam sobre os crimes de “Lavagem de Dinheiro” e demais normas e regulamentações aplicáveis, sob pena de aplicação das sanções nelas previstas. De forma que são lícitas as origens de meu patrimônio, renda e/ou faturamento, bem como não oculto ou dissimulo a natureza, a localização, a disposição ou a movimentação ou propriedade de bens, direitos e/ou valores, ou desvio, envio, patrocino, apoio ou subvenciono, de qualquer forma, o terrorismo, nos termos da Lei nº 13.260/16 (Lei Antiterrorismo). Os valores tratados à título de empréstimo são compatíveis com meus rendimentos e situação patrimonial, sendo eu, o Emitente, o beneficiário final desta operação;</p>
                            <p><span className="font-weight-bold">(ii)</span> Que não possuo recursos originados de atividades ilícitas por atos de corrupção pública ou privada, ora entendidos como aqueles que possam, de qualquer forma, prejudicar a Administração Pública, direta ou indireta, autárquica ou funcional, seja nacional ou estrangeira, a livre concorrência, a livre iniciativa ou os consumidores, nacionais e estrangeiros, nos termos da Lei nº 12.846/13 (Lei Anticorrupção);</p>
                            <p><span className="font-weight-bold">(iii)</span> Conhecer e respeitar as disposições da Lei nº 6.938/81, e suas alterações, da Lei nº 9.605/98, e demais normas e regulamentações aplicáveis, sob pena das sanções nelas previstas. De modo que não possuo recursos originados de atividades ilícitas e nocivas ao meio ambiente, de exploração de trabalho forçado ou análogo ao trabalho escravo, ou de exploração irregular de mão-de-obra infantil. Neste sentido, compreende-se como trabalho forçado ou análogo à escravidão aquele que for executado involuntariamente, sob ameaça de força ou punição, e/ou em condições precárias de higiene, liberdade e outros aspectos que violem a dignidade humana. No que tange à exploração irregular de mão-de-obra infantil, entende-se como a contratação de crianças para utilização de sua força de trabalho e/ou para exercer função que interfira na sua educação ou seja prejudicial à sua saúde e desenvolvimento físico, mental, espiritual, moral e/ou social; </p>
                            <p><span className="font-weight-bold">(iv)</span> Conhecer a Lei nº 13.709/18 (Lei Geral de Proteção de Dados) e reconhecer a condição de TITULAR de dados pessoais e as responsabilidades e sanções decorrentes desta função, de modo que o consentimento das disposições previstas nesta Cédula podem, a qualquer tempo, ser revisto e revogado mediante manifestação expressa; </p>
                            <p><span className="font-weight-bold">(v)</span> Compreender o caráter confidencial que será dado aos meus dados pessoais dispostos na presente Cédula, à exceção das ocasiões em que, por atuar em conformidade com a legislação e das normas regulatórias de autoridades competentes, inclusive internacionais, a Financeira ou qualquer outra instituição financeira adquirente desta operação poderá consultar informações consolidadas em órgãos públicos e de informações cadastrais e de crédito, bem como enviar informações de possíveis irregularidades de operações ocorridas em desacordo com o padrão de conduta ético e de transparência e integridade defendidos e esperados, nada tendo a opor e desde já consentindo quanto a realização deste procedimento, ainda que não haja comunicação prévia sobre este envio; </p>
                            <p><span className="font-weight-bold">(vi)</span> Consentir e autorizar o tratamento e operação dos dados pessoais de minha titularidade pela Financeira ou qualquer outra instituição adquirente desta operação para realização da operação de crédito contratada – envolvendo a coleta das informações ora registradas e outras constantes de demais documentos preenchidos, se for o caso;  </p>
                            <p><span className="font-weight-bold">(vii)</span> Consentir e autorizar a Financeira a negociar está operação livremente no mercado, transferindo esta Cédula por endosso ou cessão a terceiros, no todo ou em parte, de modo que serão transmitidos juntamente os dados aqui obtidos, nada tendo a opor quanto a este procedimento, independente de comunicação prévia; </p> 
                            <p><span className="font-weight-bold">(viii)</span> Concordo que a Financeira ou qualquer instituição financeira adquirente desta operação poderá solicitar informações sobre a minha capacidade financeira, fato relacionado às cessões realizadas nos termos deste Contrato ou aos CRÉDITOS que viole referidas normas, atividade econômica, operações realizadas e serviços contratados, com o objetivo de atender à legislação relativa às práticas de combate aos crimes de lavagem de dinheiro e à Lei nº 12.846/13, que dispõe sobre atos de corrupção e lesivos contra a administração pública nacional e estrangeira e outras normas correlatas.</p>

                            <p><span className="font-weight-bold">O Emitente declara, ainda:</span></p>
                            <p><span className="font-weight-bold">(i)</span> Conhecer as normas do Banco Central do Brasil, que dispõe sobre os crimes de lavagem de dinheiro e as suas obrigações; </p>
                            <p><span className="font-weight-bold">(ii)</span> Comunicar formalmente qualquer mudança de propósito e natureza da relação de negócios com a FACTA; </p> 
                            <p><span className="font-weight-bold">(iii)</span> Não participar direta ou indiretamente, com quaisquer formas de trabalho escravo e infantil ou práticas danosa ao meio ambiente;</p>
                            <p><span className="font-weight-bold">(iv)</span> Serem verdadeiras todas as informações prestadas;</p>
                            <p><span className="font-weight-bold">(v)</span> Assim como está ciente de todos os termos e condições desta CCB, responsabilizando-se por isto. </p>
                          </Col>
                        </Row>
                    ...
                    <CardBody className="text-left">
                      ...
                      <Row className="mb-3 mt-3">
                        <Col xs="12" sm="12">
                            ...
                            :
                              <div>
                                <Button className="btn-block font-weight-bold" color="outline-primary" size="lg" onClick={() =>  this.setState({ isQuestionario : true, clicou : true}) } disabled={this.state.clicou}>
                                  { this.state.etapaFinal === true
                                    ? <><strong>Concordo com os termos!</strong> <br />Confirmar assinatura</>
                                    : <>Eu <strong>li</strong> e <strong>aceito</strong> os termos</>
                                  }
                ...
                {this.state.isQuestionario === true &&
                  <Col md={{size: isMobile ? 10 : 6, offset: isMobile ? 1 : 0}} style={{ 'height' : (window.screen.height * 0.85), 'overflow' : isMobile ? "unset" : "auto" }}>
                    <FactaAuxBrasilQuestionario
                      codigo_af={AF.CODIGO}
                      vlrContratado =  {parseFloat(AF.VLR_CONTRATO).toLocaleString('pt-BR', formatoValor)}
                      juros_mensal = {AF.TAXA.toFixed(2)}
                      juros_anual = {AF.taxa_anual.toFixed(2)}
                      vlrTotalJuros = {parseFloat(AF.VLR_TOTAL_JUROS ).toLocaleString('pt-BR', formatoValor)}
                      taxa_cet = {AF.taxa_cet.toFixed(2) }
                      data_encerramento_descontos = {AF.DATAFIM}
                      valor_prev_beneficio = {AF.VLR_RAIZ}
                      total_de_parcelas = {AF.NUMEROPRESTACAO}
                      valor_prestacao = {parseFloat(AF.VLRPRESTACAO !== null ? AF.VLRPRESTACAO : 0).toLocaleString('pt-BR', formatoValor)}
                      nome_cliente={this.state.obj_cliente.DESCRICAO} 
                      salvaImgCcb = {this.salvaImgCcb}
                    />
                  </Col>
                }
              </Row>
