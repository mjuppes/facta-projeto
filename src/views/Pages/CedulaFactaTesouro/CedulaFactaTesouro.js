...
class CedulaFactaTesouro extends Component {
  ...
  render() {
    ...
    let token_fusepergs = md5('fusepergs' + ano + '-' + mes + '-' + dia);
          ...
          ?
            ...
            <Col className="w-100 p-3 min-vh-100 text-center" style={containerPaddingTop} id="ccbCliente">
                ...
                <Row className="mt-6">
                    ...
                    <CardBody className="text-left">
                      ...
                      <Row>
                        <Col xs="12" sm="12" xm="12">
                          <label>Órgão</label>
                          <p className="font-weight-bold">GOVERNO DO ESTADO DO RIO GRANDE DO SUL</p>
                        </Col>
                        ...
                        <CardBody className="text-left">
                          ...
                          <Row>
                            <Col xs="12" sm="12" xm="12" className="text-center">
                              <Button onClick={this.toggleModalSeguro} className="btn-block font-weight-bold mt-2" color="outline-primary">Visualizar bilhete do seguro</Button>
                            </Col>
                          </Row>
                  ...
                  <Card className="border-white shadow" style={{borderRadius: '8px'}}>
                    <CardBody className="text-left">
                      <h5 className="text-center border-bottom border-light pb-3">ASSOCIAÇÃO EDUCREDI</h5>
                      <Row>
                        <Col xs="12" sm="12" xm="12">
                          <FormGroup check className="checkbox">
                            <p>
                              Eu, <span className="font-weight-bold">{ this.state.obj_cliente.DESCRICAO }</span>, autorizo, pelo presente instrumento,{' '}
                              e na melhor forma de direito, a(s) empresas(s) a qual de alguma forma estou vinculado{' '}
                              a recebimento de salários, aposentadoria ou pensão, e, as instituições de crédito onde{' '}
                              mantenho conta de depósito, a descontar as importâncias que forem colocadas em cobrança{' '}
                              contra mim, pela COOPERATIVA DE ECONOMIA E CRÉDITO MÚTUO DOS PROFESSORES ESTADUAIS DA REGIÃO METROPOLITANA DE PORTO ALEGRE - EDUCREDI,{' '}
                              em razão de obrigações que eu tenha contraído com a COOPERATIVA e por transações{' '}
                              que com ela tenha efetuado, comprometendo-me, no entanto, a comunicar à COOPERATIVA,{' '}
                              sobre qualquer alteração nos dados ora informados
                            </p>
                          </FormGroup>
                        </Col>
                      </Row>
                      <Row>
                        <Col xs="12" sm="12" xm="12" className="text-center">
                          <a target="_blank" rel="noopener noreferrer" href={"https://app.factafinanceira.com.br/gerador_pdf/gerar_ccb.php?tipo_ccb=associacao_educredi&token=" + token_ccb + "&mostra_assinatura=0&tipo=1&codigo=" + this.state.codigoAF64 } className="btn btn-block font-weight-bold mt-2 btn-outline-primary">
                  ...
                  <Card className="border-white shadow" style={{borderRadius: '8px'}}>
                    <CardBody className="text-left">
                      <h5 className="text-center border-bottom border-light pb-3">ASSOCIAÇÃO AGPTEA</h5>
                      <Row>
                        <Col xs="12" sm="12" xm="12">
                          <FormGroup check className="checkbox">
                            <p>
                              Eu, <span className="font-weight-bold">{ this.state.obj_cliente.DESCRICAO }</span>, autorizo o desconto dos meus valores da mensalidade{' '}
                              e de convênios, em folha de pagamento do Tesouro ou pelo sistema de débito em minha Conta Corrente.
                            </p>
                          </FormGroup>
                        </Col>
                      </Row>
                      <Row>
                        <Col xs="12" sm="12" xm="12" className="text-center">
                          <a target="_blank" rel="noopener noreferrer" href={"https://app.factafinanceira.com.br/gerador_pdf/gerar_ccb.php?tipo_ccb=associacao_agptea&token=" + token_ccb + "&mostra_assinatura=0&tipo=1&codigo=" + this.state.codigoAF64 } className="btn btn-block font-weight-bold mt-2 btn-outline-primary">
                            Visualizar ficha da associação
                          </a>
                        </Col>
                      </Row>
                  ...
                  <Card className="border-white shadow" style={{borderRadius: '8px'}}>
                    <CardBody className="text-left">
                      <h5 className="text-center border-bottom border-light pb-3">ASSOCIAÇÃO FUSEPERGS</h5>
                      <Row>
                        <Col xs="12" sm="12" xm="12">
                          <FormGroup check className="checkbox">
                            <p>

                              Eu, <span className="font-weight-bold">{ this.state.obj_cliente.DESCRICAO }</span>, declaro serem verdadeiras as informações prestadas. Solicito, outrossim, a minha inclusão como Participante da FUSEPERGS. Autorizo, de livre e espontânea vontade, que sejam descontados de meus vencimentos/proventos/pensão, através do orgão público estadual a que estou vinculado, pelo sistema de consignação em folha de pagamento, a contribuição mensal mínima fixada pela Entidade, assim como compromissos financeiros assumidos expressamente junto a Fundação. Autorizo, também, a FUSEPERGS a debitar em minha conta corrente bancária valores devidos á Entidade, uma vez não consignados. Em caso de contratação de empréstimo em dinheiro junto a instituição financeira conveniada com a Fundação, seguros de vida, planos de previdência, ou em razão da aquisição de produtos e/ou serviços desponibilizados pela Entidade Fundacional, estou ciente de que deverei manter, de forma irrevogável, a contribuição mensal, no mínimo, até a integral liquidação dos valores devidos.
.
                            </p>
                          </FormGroup>
                        </Col>
                      ...
                      <Row>
                        <Col xs="12" sm="12" xm="12" className="text-center">
                          <a target="_blank" rel="noopener noreferrer" href={"https://app.factafinanceira.com.br/gerador_pdf/gerar_formulario_fusepergs.php?token=" + token_fusepergs + "&codigo=" + this.state.codigoAF64 } className="btn btn-block font-weight-bold mt-2 btn-outline-primary">
                            Visualizar ficha da associação
                          </a>
                        </Col>
                      </Row>
...
export default CedulaFactaTesouro;
